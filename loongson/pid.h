...
extern pid_param_t speed_pid_mid;  // 电机PID
extern pid_param_t speed_pid_dif;  // 电机PID
...
extern float speed_real_mid;
extern float speed_real_dif;
extern float speed_pwm_mid;
extern float speed_pwm_dif;
