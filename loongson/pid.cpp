...
// 电机PID初始化参数
float speed_KP = 2, speed_KI = 0,speed_KD = 0.0, speed_IMAX = 600, speed_OUTMAX = 600;
...
float speed_real_mid = 0.0;
float speed_real_dif = 0.0;
float speed_pwm_mid = 0.0;
float speed_pwm_dif = 0.0;
...
pid_param_t speed_pid_mid;  // 电机PID
pid_param_t speed_pid_dif;  // 电机PID
...
void My_Pid_Init(void)
{
    ...
    Pid_Param_Init(&speed_pid_mid, 10, 0, 0, 1500, 3000);
    Pid_Param_Init(&speed_pid_dif, 0.5, 0, 0, 1500, 3000);
}
